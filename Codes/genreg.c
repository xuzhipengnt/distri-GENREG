...
static long fpos;
 unsigned int adj_mat[MAXNUB][MAXNUB];
unsigned int dist_mat[MAXNUB][MAXNUB];
extern int Asort_a;
extern int Asort_d;
extern int Dsort_a;
extern int Dsort_d;
...
static void err()
{
 fprintf(stdout,"Abbruchfehler: Speicher voll");
 exit(0);
}
//The function will be used to compute DNA 
static void nachblist()
{
// int i,j,k;
// int k1,k2,k3,ave_path,max_path;
//  FILE *output_opt_topo_a,*output_opt_topo_d;
 //ave_path=0;
// max_path=0;
}
/*
      ...
      if (anz%1000000000==0)
{
		   ...
		   printf("Heart:%d,%llu,%f\n",jobnr,anz,MPI_Wtime()-start_t);
   fflush(stdout);
}    
